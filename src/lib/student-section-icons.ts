...
export const STUDENT_TOOL_SECTIONS: Record<string, Record<number, SectionVisualMeta>> = {
  'smart-study-guide-generator': {
    1: { title: 'Study Guide Title', stripe: 'border-indigo-500', iconWrap: 'bg-indigo-100 text-indigo-800', icon: 'bookmark' },
    2: { title: 'Chapter & Subtopic Overview', stripe: 'border-blue-500', iconWrap: 'bg-blue-100 text-blue-800', icon: 'bookOpen' },
    ...
    6: { title: 'Definitions & Formulae', stripe: 'border-amber-500', iconWrap: 'bg-amber-100 text-amber-900', icon: 'sigma' },
  ...
  'key-points-formula-extractor': {
    ...
    5: { title: 'Keywords & Terminologies', stripe: 'border-lime-500', iconWrap: 'bg-lime-100 text-lime-900', icon: 'tags' },
    ...
    8: { title: 'Frequently Asked Exam Points', stripe: 'border-indigo-500', iconWrap: 'bg-indigo-100 text-indigo-800', icon: 'target' },
    9: { title: 'Mnemonics / Memory Tricks', stripe: 'border-violet-500', iconWrap: 'bg-violet-100 text-violet-800', icon: 'zap' },
    10: { title: 'One-minute Revision Summary', stripe: 'border-amber-600', iconWrap: 'bg-amber-100 text-amber-950', icon: 'clock' },
  },
